    ...
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen w-full flex flex-col items-center justify-center px-4 py-12 lg:py-16">
        ...
        <div className="w-full max-w-7xl flex items-center justify-center relative">
          ...
          <div className="hidden lg:block absolute -left-12 xl:-left-20 bottom-0 w-80 xl:w-[450px] z-20">
            <img 
              src={mascotaVerde} 
          ...
          <div className="hidden lg:block absolute -right-12 xl:-right-20 bottom-0 w-72 xl:w-96 z-20">
            <img 
              src={mascotaRosa} 
