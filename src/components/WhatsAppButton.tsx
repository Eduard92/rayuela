...
const WhatsAppButton = () => {
  ...
  if (!empresaData?.whatsapp) return null;

  // Limpiar el número de WhatsApp (quitar espacios, guiones, etc.)
  const phoneNumber = empresaData.whatsapp.replace(/\D/g, '');
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Onda de pulso en el fondo */}
        <div className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-75"></div>

        {/* Botón principal */}
        <div className="relative bg-[#25D366] hover:bg-[#20BA5A] w-16 h-16 md:w-20 md:h-20 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 float-animation">
